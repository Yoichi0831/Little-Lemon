...
>(({ className, children, ...props }, forwardedRef) => (
  ...
  >
    <div
      // make table scrollable on mobile: whitespace-nowrap
      className={classNames("w-full overflow-auto", className)}
      {...props}
    >
      {children}
    </div>
...
>(({ className, ...props }, forwardedRef) => (
  <thead ref={forwardedRef} className={classNames(className)} {...props} />
))
